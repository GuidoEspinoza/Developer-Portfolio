    ...
    return (
        <div>
            ...
            <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
                <p className="text-sm text-[#d3d8e8]">{"Si tienes alguna pregunta o inquietud, no dudes en ponerte en contacto conmigo. Estoy abierto a cualquier oportunidad de trabajo que se alinee con mis habilidades e intereses."}</p>
