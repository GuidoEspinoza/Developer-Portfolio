    ...
    return (
        <section id="contact" className="my-12 lg:my-16 relative mt-24 text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
                {/* Contact Form */}
                <HologramCard className="order-2 lg:order-1">
                    <div className="p-6">
                        <div className="mb-6">
                            <GlitchText 
                                text="ESTABLISH_CONNECTION" 
                                className="text-xl font-bold text-cyber-cyan font-mono mb-2"
                            />
                ...
                <div className="lg:w-full order-1 lg:order-2">
                    {/* Status Panel */}
                    <HologramCard className="mb-6">
                        <div className="p-6">
                            <div className="flex items-center justify-between mb-4">
                                <GlitchText 
                                    text="CONNECTION_STATUS" 
                                    className="text-lg font-bold text-cyber-cyan font-mono"
                                />
                            ...
                            <div className="space-y-4">
                                {/* Email */}
                                <div className="flex items-center gap-4 p-3 bg-cyber-surface/30 rounded border border-cyber-cyan/20 hover:border-cyber-cyan/50 transition-colors duration-300 group">
                                    <div className="bg-cyber-cyan/20 p-2 rounded-full group-hover:bg-cyber-cyan/30 transition-colors duration-300">
                                        <MdAlternateEmail className="text-cyber-cyan" size={24} />
                                    </div>
                                    <div className="flex-1">
                                        <div className="font-mono text-xs text-gray-400 mb-1">EMAIL_PROTOCOL</div>
                                        <a 
                                            href={UI_TEXT_CONSTANTS.socialLinks.emailHref}
                                            className="text-cyber-cyan hover:text-cyber-magenta transition-colors duration-300 font-mono"
                                        >
                                            {UI_TEXT_CONSTANTS.socialLinks.email}
                                        </a>
                                    </div>
                                    <MdSignalWifi4Bar className="text-cyber-green animate-pulse" size={16} />
                                </div>

                                {/* Location */}
                                <div className="flex items-center gap-4 p-3 bg-cyber-surface/30 rounded border border-cyber-cyan/20 hover:border-cyber-cyan/50 transition-colors duration-300 group">
                                    <div className="bg-cyber-cyan/20 p-2 rounded-full group-hover:bg-cyber-cyan/30 transition-colors duration-300">
                                        <CiLocationOn className="text-cyber-cyan" size={24} />
                                    </div>
                                    <div className="flex-1">
                        ...
                        <div className="p-6">
                            <div className="mb-4">
                                <GlitchText 
                                    ...
                                    className="text-lg font-bold text-cyber-cyan font-mono mb-2"
                                />
                            ...
                            <div className="flex items-center gap-6 justify-center">
                                ...
                                >
                                    <div className="relative">
                                        <div className="bg-cyber-surface border border-cyber-cyan/50 p-4 rounded-lg hover:border-cyber-magenta hover:shadow-lg hover:shadow-cyber-cyan/25 transition-all duration-300 group-hover:scale-110">
                                            <IoLogoGithub className="text-cyber-cyan group-hover:text-cyber-magenta transition-colors duration-300" size={32} />
                                        </div>
                                        <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 font-mono text-xs text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                            GITHUB
                                        </div>
                                    </div>
                                </Link>
                                ...
                                >
                                    <div className="relative">
                                        <div className="bg-cyber-surface border border-cyber-cyan/50 p-4 rounded-lg hover:border-cyber-magenta hover:shadow-lg hover:shadow-cyber-cyan/25 transition-all duration-300 group-hover:scale-110">
                                            <BiLogoLinkedin className="text-cyber-cyan group-hover:text-cyber-magenta transition-colors duration-300" size={32} />
                                        </div>
                                        <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 font-mono text-xs text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                            LINKEDIN
                                        </div>
                            ...
                            {/* Terminal Status */}
                            <div className="mt-6 p-3 bg-black/30 rounded border border-cyber-cyan/20">
                                <div className="font-mono text-xs space-y-1">
                                    <div className="text-cyber-green">$ social_status --check</div>
